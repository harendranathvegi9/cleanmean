...
var initGlobalConfigFiles = function(config, assets) {
	...
	// Setting Globbed RAML files
	config.files.server.raml = getGlobbedPaths(assets.server.raml);
	config.files.server.clientRAML = getGlobbedPaths(assets.server.clientRAML);

	// Settnigs Globbed migration dirs
	config.files.server.orientoMigrations = getGlobbedPaths(assets.server.orientoMigrations);
